...
import com.example.homework4.thread.MyWorker;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnGetData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (id != null){
                    WorkManager.getInstance(getApplicationContext()).getWorkInfoByIdLiveData(id).observe(MainActivity.this, new Observer<WorkInfo>() {
                        @Override
